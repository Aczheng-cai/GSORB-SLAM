...
{
    cout<<new_mean3D.is_leaf()<<endl;
cout<<new_rgb.is_leaf()<<endl;
cout<<new_logit_opacities.is_leaf()<<endl;
cout<<new_log_scales.is_leaf()<<endl;
cout<<new_unnorm_qua.is_leaf()<<endl;
